...
#A REGULARICAÇÃO PODE SER COLOCADA EM QUALQUER CAMADA
modelo.add(Dense(30, input_dim=784, kernel_initializer='normal', activation='relu', kernel_regularizer=regularizers.l2(0.01))) #primeira camada oculta #COM REGULARIZAÇÃO
...
#iremos usar o Adadelta como otimizador
#fazer os testes alterando as funções e verificar o resultado mais abaixo gerado na variável 'historico' e no gráfico
otimizador = Adadelta()   #é aqui a única diferença em relação ao executado no modelo anterior
