...
mninst = input_data.read_data_sets('MNIST_data/', one_hot=True) #este método é especifico do dataset que já existe dentro do tensorflow, já usando o one hot encode para criar as novas colunas com os valores da variável target
