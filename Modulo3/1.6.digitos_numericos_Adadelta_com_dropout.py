...
y_treino_convertido = np_utils.to_categorical(y_treino) #converte a coluna de valores em uma matriz de classes (one hot encode)
...
modelo.add(Dropout(0.2))  #UTILIZANDO DROPOUT DE 20%
