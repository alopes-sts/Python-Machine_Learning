...
#Exemplo de como verificar graficamente os dados de treino
import warnings
...
########## Criando as lista para armazenar a acurácia e as épocas durante o treinamento ##########
historico_acc = []
historico_epochs = []
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        custo_medio = 0.0
        total_batches = int(
            mnist.train.num_examples / batch_size)  # 'mnist.train.num_examples' retorna o total de amostras, este dataset já foi disponibilizado com os dados de treino e teste dentro da biblioteca do TensorFlow
        ...
        historico_acc.append(acuracia_teste)  ########## adicionando elementos na lista para o gráfico
        historico_epochs.append(epoch+1)      ########## adicionando elementos na lista para o gráfico
